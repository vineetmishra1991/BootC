	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.num}">
				<li class="fieldcontain">
					<span id="num-label" class="property-label"><g:message code="user.num.label" default="Num" /></span>
					
						<span class="property-value" aria-labelledby="num-label"><g:fieldValue bean="${userInstance}" field="num"/></span>

...
class BootstrapService {
    ...
    def userInit() {
        ...
        User usr7 = new User(firstname: 'harryp', lastname: 'singha', address: 'delhi', password: 'harryp', confirmPassword: 'harryp', email: 'harry1@gmail.com', male: true, dateOfBirth: new Date())
        User usr8 = new User(firstname: 'harryq', lastname: 'singhb', address: 'assam', password: 'harryp', confirmPassword: 'harryp', email: 'harry2@gmail.com', male: true, dateOfBirth: new Date())
        User usr9 = new User(firstname: 'harryr', lastname: 'singhc', address: 'punjabb', password: 'harryp', confirmPassword: 'harryp', email: 'harry3@gmail.com', male: true, dateOfBirth: new Date())
        User usr10 = new User(firstname: 'harrys', lastname: 'singhd', address: 'delhi', password: 'harryp', confirmPassword: 'harryp', email: 'harry4@gmail.com', male: true, dateOfBirth: new Date())

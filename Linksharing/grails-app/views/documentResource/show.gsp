			...
			<ol class="property-list documentResource">
				...
				<li class="fieldcontain">
					<span id="owner-label" class="property-label"><g:message code="documentResource.owner.label" default="Owner" /></span>
						...
						<span class="property-value" aria-labelledby="owner-label"><g:link controller="user" action="show" id="${documentResourceInstance?.owner?.id}">${documentResourceInstance?.owner?.encodeAsHTML()}</g:link></span>
